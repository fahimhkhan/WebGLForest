...
// Use this version if want to pick only one tree
// ================================================	
	if (mode == 0){
		if (selected == 0){
			if (pixels[0] == 0){
...
// Use this version if want to pick multiple trees
// ================================================		
	// if (mode == 0){
			// if (pixels[0] == 0){
			...
			// }
			// else{
				// if (g_points[(idx-1)][2] == 0 || g_points[(idx-1)][2] == 2) g_points[(idx-1)][2]++;
				// selected = idx;
				// }
			// }
// ================================================
